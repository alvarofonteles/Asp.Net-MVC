...
namespace Info.DAO
{
    ...
    partial void InsertContasAReceber(ContasAReceber instance);
    partial void UpdateContasAReceber(ContasAReceber instance);
    partial void DeleteContasAReceber(ContasAReceber instance);
    ...
    partial void DeleteUsuario(Usuario instance);
		...
		public InfoDataContext() : 
				base(global::Info.DAO.Properties.Settings.Default.db_infoConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<ContasAReceber> ContasARecebers
		{
			get
			{
				return this.GetTable<ContasAReceber>();
			}
		}
    ...
    partial void OnEmailChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Pessoa_PessoaFisica", Storage="_PessoaFisica", ThisKey="Codigo", OtherKey="CodigoPesso", IsUnique=true, IsForeignKey=false)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Pessoa_PessoaJuridica", Storage="_PessoaJuridica", ThisKey="Codigo", OtherKey="CodigoPessoa", IsUnique=true, IsForeignKey=false)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Pessoa_tb_usuario", Storage="_Usuario", ThisKey="Codigo", OtherKey="CodigoPessoa", IsUnique=true, IsForeignKey=false)]
    ...
    partial void OnCodigoPessoChanging(int value);
    partial void OnCodigoPessoChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="id_pessoa", Storage="_CodigoPesso", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int CodigoPesso
		{
			get
			{
				return this._CodigoPesso;
			}
			set
			{
				if ((this._CodigoPesso != value))
				{
					this.OnCodigoPessoChanging(value);
					this.SendPropertyChanging();
					this._CodigoPesso = value;
					this.SendPropertyChanged("CodigoPesso");
					this.OnCodigoPessoChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Pessoa_PessoaFisica", Storage="_Pessoa", ThisKey="CodigoPesso", OtherKey="Codigo", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._Pessoa.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._CodigoPesso = value.Codigo;
					}
					else
					{
						this._CodigoPesso = default(int);
					}
	...
	public partial class Venda : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<ContasAReceber> _ContasARecebers;
    ...
    partial void OnCodigoPessoaChanged();
		...
		{
			this._ItensVendas = new EntitySet<ItensVenda>(new Action<ItensVenda>(this.attach_ItensVendas), new Action<ItensVenda>(this.detach_ItensVendas));
			this._ContasARecebers = new EntitySet<ContasAReceber>(new Action<ContasAReceber>(this.attach_ContasARecebers), new Action<ContasAReceber>(this.detach_ContasARecebers));
			this._Pessoa = default(EntityRef<Pessoa>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Venda_ContasAReceber", Storage="_ContasARecebers", ThisKey="CodigoVenda", OtherKey="CodigoVenda")]
		public EntitySet<ContasAReceber> ContasARecebers
		{
			get
			{
				return this._ContasARecebers;
			}
			set
			{
				this._ContasARecebers.Assign(value);
			}
		}
		...
		private void attach_ContasARecebers(ContasAReceber entity)
		{
			this.SendPropertyChanging();
			entity.Venda = this;
		}
		
		private void detach_ContasARecebers(ContasAReceber entity)
		{
			this.SendPropertyChanging();
			entity.Venda = null;
		}
	...
	public partial class ContasAReceber : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnCodigoStatusChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Venda_ContasAReceber", Storage="_Venda", ThisKey="CodigoVenda", OtherKey="CodigoVenda", IsForeignKey=true)]
		public Venda Venda
		{
			get
			{
			...
			set
			{
							...
							|| (this._Venda.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Venda.Entity = null;
						previousValue.ContasARecebers.Remove(this);
					}
					this._Venda.Entity = value;
					if ((value != null))
					{
						value.ContasARecebers.Add(this);
						this._CodigoVenda = value.CodigoVenda;
					}
					else
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="StatusPagamento_ContasAReceber", Storage="_StatusPagamento", ThisKey="CodigoStatus", OtherKey="CodigoStatus", IsForeignKey=true)]
    ...
    partial void OnStatusChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="StatusPagamento_ContasAReceber", Storage="_ContasARecebers", ThisKey="CodigoStatus", OtherKey="CodigoStatus")]
		public EntitySet<ContasAReceber> ContasARecebers
		{
			get
			{
    ...
    partial void OnCodigoPessoaChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Pessoa_tb_usuario", Storage="_Pessoa", ThisKey="CodigoPessoa", OtherKey="Codigo", IsForeignKey=true)]
		public Pessoa Pessoa
		{
			get
			{
